"""
Generative Tag Namer using Open Source LLMs
Uses transformer-based language models to generate descriptive tag names for content clusters.
"""
...
class GenerativeTagNamer(TagNamer):
    """
    Generative tag namer using open source LLMs to create descriptive tag names
    ...
    def __init__(self, 
                 ...
                 device = 'mps'):
        """
        Initialize the GenerativeTagNamer.
    ...
    def _setup_model(self):
        """Setup the language model and tokenizer."""
    ...
    def _create_tag_generation_prompt(self, titles_text: str, unavailable_tag: str = None) -> str:
        ...
        prompt = f"""Based on these content titles, generate a short descriptive topic that encompasses the high level topic (1-3 words):
    ...
    def _create_parent_tag_prompt(self, child_tags_text: str, unavailable_tag:str=None) -> str:
        ...
        prompt = f"""Given these related topic tags, generate a broader category name that encompasses the high level topic (1-2 words):
    ...
    def set_model_parameters(self, max_new_tokens: int = None, temperature: float = None):
    ...
    def get_model_info(self) -> dict:
        ...
        return {
            ...
            "device": next(self.model.parameters()).device if hasattr(self, 'model') else "unknown"
        }
